    ...
    const cronogramasConDetalles = await Promise.all(
      data.records.map(async (record: any) => {
        ...
        return {
          ...
          fechaInicio: CRONOGRAMA_FECHA_INICIO_FIELD ? record.fields[CRONOGRAMA_FECHA_INICIO_FIELD] || '' : '',
          realizaRegistro: CRONOGRAMA_REALIZA_REGISTRO_FIELD ? record.fields[CRONOGRAMA_REALIZA_REGISTRO_FIELD] || false : false,
